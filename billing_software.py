...
class Bill_App:
    def __init__(self, root):  
        ...
        bg_color = "#"
        title = Label(self.root, text="Billing Software", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg="#2596be", fg="Black", relief=GROOVE)
        title.pack(fill=X)
    # ================variables=======================
    ...
    # =============customer retail details======================
        F1 = LabelFrame(self.root, text="Customer Details", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#abdbe3")
        F1.place(x=0, y=80, relwidth=1)
        cname_lbl = Label(F1, text="Customer Name:", bg="#abdbe3", font=('times new roman', 15, 'bold'))
        cname_lbl.grid(row=0, column=0, padx=20, pady=5)
        cname_txt = Entry(F1, width=15, textvariable=self.c_name, font='arial 15', bd=7, relief=GROOVE)
        cname_txt.grid(row=0, column=1, pady=5, padx=10)

        cphn_lbl = Label(F1, text="Customer Phone:", bg="#abdbe3", font=('times new roman', 15, 'bold'))
    ...
    # ===================Medical====================================
        F2 = LabelFrame(self.root, text="Medical Purpose", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#abdbe3")
        F2.place(x=5, y=180, width=325, height=380)

        sanitizer_lbl = Label(F2, text="Sanitizer", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        ...
        mask_lbl = Label(F2, text="Mask", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        ...
        hand_gloves_lbl = Label(F2, text="Hand Gloves", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        ...
        dettol_lbl = Label(F2, text="Dettol", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        ...
        Neosporin_lbl = Label(F2, text="Neosporin", font =('times new roman', 16, 'bold'), bg = "#abdbe3", fg = "black")
        Neosporin_lbl.grid(row=4, column=0, padx=10, pady=10, sticky='W')
        Neosporin_txt = Entry(F2, width=10, textvariable=self.newsprin, font=('times new roman', 16, 'bold'), bd=5, relief=GROOVE)
        Neosporin_txt.grid(row=4, column=1, padx=10, pady=10)

        thermal_gun_lbl = Label(F2, text="Thermal Gun", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
    ...
    # ==========GroceryItems=========================
        F3 = LabelFrame(self.root, text="Grocery Items", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#abdbe3")
        F3.place(x=340, y=180, width=325, height=380)

        rice_lbl = Label(F3, text="Rice", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        ...
        food_oil_lbl = Label(F3, text="Food Oil", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        ...
        wheat_lbl = Label(F3, text="Wheat", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        ...
        Pulses_lbl = Label(F3, text="Pulses", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        Pulses_lbl.grid(row=3, column=0, padx=10, pady=10, sticky='W')
        Pulses_txt = Entry(F3, width=10, textvariable=self.daal, font=('times new roman', 16, 'bold'), bd=5, relief=GROOVE)
        Pulses_txt.grid(row=3, column=1, padx=10, pady=10)

        flour_lbl = Label(F3, text="Flour", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        ...
        maggi_lbl = Label(F3, text="Maggi", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
    ...
    # ===========ColdDrinks================================
        F4 = LabelFrame(self.root, text="Cold Drinks", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#abdbe3")
        F4.place(x=670, y=180, width=325, height=380)

        sprite_lbl = Label(F4, text="Sprite", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        ...
        limka_lbl = Label(F4, text="Limca", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        ...
        mazza_lbl = Label(F4, text="Maaza", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        ...
        coke_lbl = Label(F4, text="Coke", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        ...
        fanta_lbl = Label(F4, text="Fanta", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
        ...
        mountain_duo_lbl = Label(F4, text="Mountain Dew", font=('times new roman', 16, 'bold'), bg="#abdbe3", fg="black")
    ...
    # =======================ButtonFrame=============
        F6 = LabelFrame(self.root, text="Bill Area", font=('times new roman', 14, 'bold'), bd=10, fg="Black", bg="#abdbe3")
        F6.place(x=0, y=560, relwidth=1, height=140)

        m1_lbl = Label(F6, text="Total Medical Price", font=('times new roman', 14, 'bold'), bg="#abdbe3", fg="black")
        ...
        m2_lbl = Label(F6, text="Total Grocery Price", font=('times new roman', 14, 'bold'), bg="#abdbe3", fg="black")
        ...
        m3_lbl = Label(F6, text="Total Cold Drinks Price", font=('times new roman', 14, 'bold'), bg="#abdbe3", fg="black")
        ...
        m4_lbl = Label(F6, text="Medical Tax", font=('times new roman', 14, 'bold'), bg="#abdbe3", fg="black")
        ...
        m5_lbl = Label(F6, text="Grocery Tax", font=('times new roman', 14, 'bold'), bg="#abdbe3", fg="black")
        ...
        m6_lbl = Label(F6, text="Cold Drinks Tax", font=('times new roman', 14, 'bold'), bg="#abdbe3", fg="black")
...
#================totalBill==========================
    def total(self):
        ...
        self.c_tax = round((self.total_medical_price*0.05)/100, 2)
        ...
        self.g_tax = round((self.total_grocery_price*0.5)/100, 2)
        ...
        self.c_d_tax = round((self.total_cold_drinks_price * 0.1)/100, 2)
...
#==============welcome-bill==============================
    def welcome_bill(self):
        ...
        self.txtarea.insert(END, "\tWelcome  Retail")
...
obj = Bill_App(root)
root.mainloop()
# Check if 'bills' directory exists, and create it if not
